...
(function($) {
    ...
    console.log(self.options);
		...
		var is_video = model.o.file[self._file].filetype === FILETYPES.TYPE_YOUTUBE;
                ...
                var questionoption = self._doEdit ? " " : "<span><input type='checkbox' id='checkbox_question' value='question'/><label for='checkbox_question'>Reply Request</label></span><br/> ";
		...
		var section_tag_option = ""; //hack to hide tags
                ...
                var emoticon1 = "<input title='curious' onclick='add_tag("+'"curious"'+");' type='image' id='cur' src='/content/modules/dev/emoticons/curious.png' style='height:24px;width:24px;margin:5px;' />";
                var emoticon2 = "<input title='confused' onclick='add_tag("+'"confused"'+");' type='image' id='con' src='/content/modules/dev/emoticons/confused.png' style='height:24px;width:24px;margin:5px;' />";
                var emoticon3 = "<input title='helpful' onclick='add_tag("+'"helpful"'+");' type='image' id='helpful' src='/content/modules/dev/emoticons/helpful.png' style='height:24px;width:24px;margin:5px;' />";
                var emoticon4 = "<input title='intersted' onclick='add_tag("+'"intersted"'+");' type='image' id='inte' src='/content/modules/dev/emoticons/interested.png' style='height:24px;width:24px;margin:5px;' />";
                var emoticon5 = "<input title='frustrated' onclick='add_tag("+'"frustrated"'+");' type='image' id='frus' src='/content/modules/dev/emoticons/frustrated.png' style='height:24px;width:24px;margin:5px;' />";
                var emoticon6 = "<input title='help' onclick='add_tag("+'"help"'+");' type='image' id='help' src='/content/modules/dev/emoticons/help.png' style='height:24px;width:24px;margin:5px;' />";
                var emoticon7 = "<input title='question' onclick='add_tag("+'"question"'+");' type='image' id='quest' src='/content/modules/dev/emoticons/questionMark.png' style='height:24px;width:24px;margin:5px;' />";
                var emoticon8 = "<input title='idea' onclick='add_tag("+'"idea"'+");' type='image' id='idea' src='/content/modules/dev/emoticons/idea.png' style='height:24px;width:24px;margin:5px;' />";

                //var emoticonsList = "<label for='comment_tag'>I'm feeling:&nbsp;</label><select id='comment_tag' name='tag_" + id_item + "'><option value='0'>choose option</option>"+emoticon1+emoticon2+emoticon3+emoticon4+"</select>";
                var tmp = "var txt=document.getElementById('commentTB').value;txt='#' + type + ' ' + txt ;document.getElementById('commentTB').value=txt;";
                //var fun = "<script> function add_tag(type) {if(type==0) {window.alert('curious');} else if(type==1) {window.alert('confused');} else if(type==2) {window.alert('helpful');} else {window.alert('intersted');}} </script>";
          ...
          msg.pause = self._sel ? $("#checkbox_pause")[0].checked:0;
                    ...
                    console.log(msg);
                    //next line add the data into data base
